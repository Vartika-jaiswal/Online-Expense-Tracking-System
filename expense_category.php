...
<body>
 ...
 ?>          
    ...
    <div class="content">
       ...
       <input type="text" name="expense_category_name" id="expense_category_name" style=" margin-left:-50px" class="form-control" placeholder="PLease Enter Expense Name"  required>
                     </div>
                   ...
                   <label> Enter Amount : </label>
                      <input type="text" name="amount" id="amount" style="margin-left:-50px" class="form-control"placeholder="Please Enter Category Name :"   onBlur="this.value=trim(this.value);" required>
    ...
    <tbody>
					...
					$sql = mysqli_query($con, "SELECT * FROM expense_category_tbl order by expense_category_name ASC");
							...
							echo '<td>'. $date=DATE_FORMAT(new DateTime($row['created_at']),'d-M-Y') . '</td>';
