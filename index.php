                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Enter Expenses</h4>
                                        </div>
    ...
    <div class="content">
        ...
        <div class="form-group">
          <label for="expense_category_id">Expense Name:</label>
            <select class="form-control" name="expense_category_id" id="expense_category_id" style="margin-left:-50px" required="">
           ...
           <?php endwhile; ?>   
            ...
            <label> Amount Spent: </label>
                <input type="text" name="amount_spent" id="amount_spent" style="margin-left:-50px" class="form-control"placeholder="Please Enter Expense amount_spent :"   onBlur="this.value=trim(this.value);" required>
            ...
            <label> Expense Description: </label>
                <input type="text" name="expense_description" id="expense_description" style="margin-left:-50px" class="form-control"placeholder="Please Enter Expense Description :"   onBlur="this.value=trim(this.value);" required>
        ...
        <div class="form-group">
            <label> Date: </label>
                <input type="date" name="expense_date" id="expense_date" style="margin-left:-50px" class="form-control"placeholder="Please Enter Expense Date :"   onBlur="this.value=trim(this.value);" required>
...
// } 
              ...
              if($diff < 0 ){
                echo '<td ><div class="btn btn-danger btn-xs" title="You have over spent  '.$row['expense_category_name'].'  budget">'. number_format((float)($diff), 2, '.', '') . '</div></td>';
              }

              if($diff > 0 ){
                echo '<td ><div class="btn btn-primary btn-xs" title="You are within '.$row['expense_category_name'].'  budget"">'.number_format((float)($diff), 2, '.', '') . '</div></td>';
              }
              // echo '<td>'. $row['expense_date'] . '</td>';
						    echo '<td>';
							  echo '  ';
                echo '<a class="btn btn-danger btn-xs" href="delete.php?id='.$row['expense_category_id'].'"> <i class="glyphicon glyphicon-trash icon-white"></i>Delete</a>';
                echo '</td>';
						}
